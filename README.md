...
```bash
# 下载脚本
wget -O bbr_control.sh https://raw.githubusercontent.com/your-repo/bbr_control.sh

# 或使用 curl
curl -o bbr_control.sh https://raw.githubusercontent.com/your-repo/bbr_control.sh
